...
def run():
    ...
    time.sleep(global_configs.Maku_inner_wait_time)
    ...
    # Click to throw
    MouseAction.left_long_click(200, 200, global_configs.Maku_floating_throwing_time)
    # Wait a few seconds
    time.sleep(global_configs.Maku_floating_after_throwing_waiting_time)
    # Limited the fishing line
    MouseAction.left_long_click(200, 200, global_configs.Maku_floating_straining_line_time)
    ...
    max_time = global_configs.Maku_max_waiting_time / 0.2
    ...
    while max_time > 0:
        ...
        if d > 0.5:
            ...
            MouseAction.hold_on_right_then_left(200, 200,
                                                right_hold_time=global_configs.Maku_floating_lift_rod_time,
                                                both_hold_time=global_configs.Maku_floating_lift_fish_time)
